...
for i in range (10):
    def generate_comment():
        ...
        if choice == 0:
            submission.reply(generate_comment_0())
        elif choice == 1:
            submission.reply(generate_comment_1())
        elif choice == 2:
            submission.reply(generate_comment_2())
        elif choice == 3:
            submission.reply(generate_comment_3())
        elif choice == 4: 
            submission.reply(generate_comment_4())
        else:
            submission.reply(generate_comment_5())
